...
\item v3.05 -- updated section \ref{sec:naming-variable} to clarify that the names of function parameters should follow the variable naming convention. Updated example \ref{lst:indent8} to make the pointers \texttt{const}.
\end{itemize}
