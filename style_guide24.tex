...
\lstinputlisting{examples/indent1.c}
\linenumbers
...
\lstinputlisting{examples/indent2.c}
	\linenumbers
...
\lstinputlisting{examples/indent3.c}
\linenumbers
...
\lstinputlisting{examples/indent4.c}
\linenumbers
...
\nolinenumbers
\lstset{caption={Continuation lines for for loops}}
\lstinputlisting{examples/indent5.c}
\linenumbers
...
\lstinputlisting{examples/indent6.c}
\linenumbers
...
\lstinputlisting{examples/indent7.c}
\linenumbers
...
\lstinputlisting{examples/space1.c}
\linenumbers
...
\lstinputlisting{examples/space2.c}
\linenumbers
...
\lstinputlisting{examples/space3.c}
\linenumbers
...
\nolinenumbers
\lstset{caption={Spacing in control statements and function calls}}
\lstinputlisting{examples/space4.c}
\linenumbers
...
\lstinputlisting{examples/line1.c}
\linenumbers
...
\lstinputlisting{examples/line2.c}
\linenumbers
...
\nolinenumbers
\lstset{caption={Opening brace for function definitions}}
\lstinputlisting{examples/brace1.c}
\linenumbers
...
\nolinenumbers
\lstset{caption={Braces for control statements}}
\lstinputlisting{examples/brace2.c}
\linenumbers
...
\lstinputlisting{examples/name1.c}
\linenumbers
...
\lstinputlisting{examples/name2.c}
\linenumbers
...
\lstinputlisting{examples/name3.c}
\linenumbers
...
\lstinputlisting{examples/name4.c}
\linenumbers
