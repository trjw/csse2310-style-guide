...
\texttt{clang-format}, \texttt{clang-tidy} and \texttt{doxygen} (with the appropriate arguments), i.e. those items indicated by the \icon{CLANG-FORMAT}, \icon{CLANG-TIDY} and \icon{DOXYGEN} icons below. Details of the lines on which issues are found are reported to standard output. 
