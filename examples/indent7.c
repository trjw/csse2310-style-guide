...
double d1[10] = {1.11111111, 2.2222222, 3.3333333, 4.4444444, 5.555555};
struct Parameters1 param1 = {.initial = NULL, .end = NULL, .runningCount = 0};
// Initialiser list fits by itself on a continuation line:
double d2[10]
        = {1.11111111, 2.2222222, 3.3333333, 4.4444444, 5.555555, 6.666666};
...
struct Parameters3 param3 = {NULL, NULL, 0, NULL, 0, false, true, 0, NULL, NULL,
