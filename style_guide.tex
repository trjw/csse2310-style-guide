...
\lstset{caption={Recommend function comment template}, label={lst:function-comment}}
\begin{lstlisting}
/* function_name()
 * ---------------
 ...
 * Errors: (if applicable) description of what happens if an error occurs, e.g. what value is 
 *     returned or if the program exits (i.e. function does not return) under certain circumstances.
